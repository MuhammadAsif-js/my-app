...
export function generateMetadata({ params }) {
  return {
    ...
    description:
      "Calculate simple interest only with our free simple interest only calculator. This article will help you calculate simple interest only with our free simple interest only calculator.",
    keywords:
      "simple interest only, simple interest only calculator, simple interest only calc, simple interest only formula, simple interest only formula calculator, simple interest only formula calc, simple interest only formula calculator, simple interest only formula calc, simple",
  };
}
